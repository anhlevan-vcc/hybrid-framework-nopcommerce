...
public class Level_23_SeleniumGrid extends BaseTest {
	...
	@Parameters({ "browser", "serverName", "ipAddress", "portNumber" })
	@BeforeClass
	public void beforeClass(String browserName, String severName, String ipAddress, String portNumber) {
		driver = getBrowserDriverGrid(browserName, severName, ipAddress, portNumber);
